  ...
  return (
    <div className={props.first === true ? "firsttodoofrow card" : "card"} styles="width: 18rem;">
      ...
      <div className="card-body">
        ...
        <button className="btn btn-outline-danger" onClick={() => { props.deletetodo(props.todo, props.sno) }}>
          Delete This Todo&nbsp;&nbsp;
        ...
        <button className="btn btn-outline-primary flo" onClick={async () => { props.edittodo(props.todo) }}>
